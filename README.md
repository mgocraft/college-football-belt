...
The `/ads.txt` endpoint emits the exact string Google requests for this property: `google.com, pub-7568133290427764, DIRECT, f08c47fec0942fa0`. If you supply your own publisher ID through `NEXT_PUBLIC_ADSENSE_PUBLISHER_ID`, the route automatically swaps in your value (preserving the `DIRECT` relationship and Google certification ID), so no additional manual edits are required.
